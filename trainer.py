...
class Trainer:
    ...
    #def __init__(self, epochs: int, lr: float, net: network.Net, train_loader: DataLoader, val_loader: DataLoader,):
    def __init__(self, epochs: int, lr: float, net: network.Net, train_loader: DataLoader, val_loader: DataLoader,device):
        """
